...
export default class HelloWorldScene extends Phaser.Scene
{
	...
	preload()
    {
        ...
        this.load.image('star', 'assets/potion.png');
    ...
    create()
    {
        ...
        this.song = this.sound.add('music', {volume: 0.1});
        this.song.play();
    ...
    var bestScore = Math.max.apply(null, this.allScores );

    bestScore< 0 ? bestScore = 0 : bestScore = bestScore; 

    this.bestScoreText = this.add.text(16,42, `Record: ${bestScore}`, {
        fontSize: '32px',
        fill: '#FFFF00'
